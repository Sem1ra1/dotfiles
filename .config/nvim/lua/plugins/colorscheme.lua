	...
	config = function()
		...
		require("andromeda").setup({
			...
			on_colors = function(colors)
				-- Base color palette
				colors.cyan = "#44d2d4" -- Primary accent, identifiers
			...
			on_highlights = function(highlights, colors)
				...
				highlights["@operator.css"] = { fg = colors.magenta } -- root 'DOCTYPE' tag
				highlights["@operator.css"] = { fg = colors.magenta } -- root 'DOCTYPE' tag
				highlights["@function.css"] = { fg = colors.orange } -- root 'DOCTYPE' tag
				-- highlights["@property.css"] = { fg = colors.fg } -- root 'DOCTYPE' tag
				highlights["@punctuation.bracket.css"] = { fg = colors.yellow } -- root 'DOCTYPE' tag
				highlights["@variable.builtin.javascript"] = { fg = colors.purple } -- root 'DOCTYPE' tag
				-- highlights["@operator.javascript"] = { fg = colors.magenta } -- root 'DOCTYPE' tag
